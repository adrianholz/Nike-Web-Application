      ...
      <main className="product-page">
        ...
        <div className="product-page-inner">
          <div className="product-page-item">
            <img src="/img/png/women-1.png" alt="Nike Women's Shoes" />
          ...
          <div className="product-page-item">
            <img src="/img/png/women-2.png" alt="Nike Women's Shoes" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <span>$89</span>
            <a href="#" className="call-to-action">
              Add to Cart
          ...
          <div className="product-page-item">
            <img src="/img/png/women-3.png" alt="Nike Women's Shoes" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <span>$89</span>
            <a href="#" className="call-to-action">
              Add to Cart
          ...
          <div className="product-page-item">
            <img src="/img/png/women-4.png" alt="Nike Women's Shoes" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <span>$89</span>
            <a href="#" className="call-to-action">
              Add to Cart
