      ...
      <main className="product-page">
        ...
        <div className="product-page-inner">
          <div className="product-page-item">
            <img src="/img/png/sale-1.png" alt="Nike Shoes on Sale" />
          ...
          <div className="product-page-item">
            <img src="/img/png/sale-2.png" alt="Nike Shoes on Sale" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <div className="prices">
              <span>
                <s>$89</s>
          ...
          <div className="product-page-item">
            <img src="/img/png/sale-3.png" alt="Nike Shoes on Sale" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <div className="prices">
              <span>
                <s>$89</s>
          ...
          <div className="product-page-item">
            <img src="/img/png/sale-4.png" alt="Nike Shoes on Sale" />
            <h2>Nike Air Max Ultra Blaster</h2>
            <div className="prices">
              <span>
                <s>$89</s>
